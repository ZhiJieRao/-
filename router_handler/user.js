...
*/
         ...
         */
        //对用户的密码,进行 bcrype 加密，返回值是加密之后的密码字符串,加密过后无法被逆向破解
        ...
        //这里第二个参数并没有直接填req.body,因为req.body还包含其他属性，而这里只想要username和password
...
exports.login = (req, res) => {
     ...
     */
    const compareResult = bcrypt.compareSync(userinfo.password, results[0].password)//第一个参数为数据库密码，第二个参数为用户输入的密码
